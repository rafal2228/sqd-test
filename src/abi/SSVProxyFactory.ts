...
export const events = {
    ...
    P2pSsvProxyFactory__SsvOperatorIdsSet: event("0xdcb0babe4f0d3603570b9dc8c9f7c10843aae0ec6478971ec4ee989babe6beb9", "P2pSsvProxyFactory__SsvOperatorIdsSet(address,uint64[8])", {"_ssvOperatorOwner": indexed(p.address), "_operatorIds": p.fixedSizeArray(p.uint64, 8)}),
...
export const functions = {
    ...
    getAllowedSsvOperatorIds: viewFun("0xcfbe2e78", "getAllowedSsvOperatorIds(address)", {"_ssvOperatorOwner": p.address}, p.fixedSizeArray(p.uint64, 8)),
    ...
    'setSsvOperatorIds(uint64[8],address)': fun("0x6494731e", "setSsvOperatorIds(uint64[8],address)", {"_operatorIds": p.fixedSizeArray(p.uint64, 8), "_ssvOperatorOwner": p.address}, ),
    'setSsvOperatorIds(uint64[8])': fun("0xdfb86bb7", "setSsvOperatorIds(uint64[8])", {"_operatorIds": p.fixedSizeArray(p.uint64, 8)}, ),
...
export class Contract extends ContractBase {
    ...
    predictP2pSsvProxyAddress(_feeDistributorInstance: PredictP2pSsvProxyAddressParams["_feeDistributorInstance"]) {
        return this.eth_call(functions.predictP2pSsvProxyAddress, {_feeDistributorInstance})
    }
...
export type DepositEthAndRegisterValidatorsParams = FunctionArguments<typeof functions.depositEthAndRegisterValidators>
export type DepositEthAndRegisterValidatorsReturn = FunctionReturn<typeof functions.depositEthAndRegisterValidators>
...
export type PredictP2pSsvProxyAddressParams = FunctionArguments<typeof functions.predictP2pSsvProxyAddress>
export type PredictP2pSsvProxyAddressReturn = FunctionReturn<typeof functions.predictP2pSsvProxyAddress>

export type RegisterValidatorsParams = FunctionArguments<typeof functions.registerValidators>
export type RegisterValidatorsReturn = FunctionReturn<typeof functions.registerValidators>
...
export type SetSsvOperatorIdsParams_0 = FunctionArguments<typeof functions['setSsvOperatorIds(uint64[8],address)']>
export type SetSsvOperatorIdsReturn_0 = FunctionReturn<typeof functions['setSsvOperatorIds(uint64[8],address)']>

export type SetSsvOperatorIdsParams_1 = FunctionArguments<typeof functions['setSsvOperatorIds(uint64[8])']>
export type SetSsvOperatorIdsReturn_1 = FunctionReturn<typeof functions['setSsvOperatorIds(uint64[8])']>
